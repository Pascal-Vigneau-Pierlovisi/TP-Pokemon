...
public class Pokemon implements Serializable {
        ...
        for (String type : this.getLst_types()) {
            if (lesAttaques.get(0) == null) {
                switch (type) {
                    ...
                    case "PLANT":
                        lesAttaques.set(0,
                                new Attaque("Fouet liane", "Physique", 100, 40, "PLANT", listTypes.getListType()));
                        break;
                    case "ELECTRIC":
                        lesAttaques.set(0,
    ...
    public String toString() {
        ...
        return "Nom: " + this.nom + "; N°: " + this.numPokedex + "; Type: " + this.lst_types + "; Ses attaques: "
                + this.lesAttaques;
    }
                    ...
                    if (lesAttaques.get(1) == null) {
                        switch (type) {
                            ...
                            case "POISON":
                                ...
                                break;
                            case "PLANT":
                                lesAttaques.set(1, new Attaque("Feuille Magic", "Special", 1000, 60, "PLANT",
                                        listTypes.getListType()));
                                break;
                            case "ELECTRIC":
                        ...
                        switch (type) {
                            ...
                            case "POISON":
                                ...
                                break;
                            case "PLANT":
                                lesAttaques.set(2, new Attaque("Feuille Magic", "Special", 1000, 60, "PLANT",
                                        listTypes.getListType()));
                                break;
                            case "ELECTRIC":
                        ...
                        switch (type) {
                            ...
                            case "POISON":
                                ...
                                break;
                            case "PLANT":
                                lesAttaques.set(3, new Attaque("Feuille Magic", "Special", 1000, 60, "PLANT",
                                        listTypes.getListType()));
                                break;
                            case "ELECTRIC":
    ...
    public void attaquer(Pokemon pokAdv) {
        ...
        pokAdv.pv -= ((this.niveau * 0.4 + 2) * this.atk * this.lesAttaques.get(atkUtilise).getPuissance() / pokAdv.def
                * 50)
                * this.lesAttaques.get(atkUtilise).calculEfficacite(pokAdv)
                * this.lesAttaques.get(atkUtilise).calculResistance(pokAdv)
                * this.lesAttaques.get(atkUtilise).isNeutre(pokAdv);
        if (pokAdv.pv <= 0) {
            pokAdv.ko = true;
        }
        myObj.close();
